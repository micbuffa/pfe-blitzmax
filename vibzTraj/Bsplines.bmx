...
Type TBSplines
	...
	Method update:Int[](speed:Float) 			
		...
		SetColor 255, 0, 0
		DrawOval curKubSplineX.ValueInt(tPos) - radius, curKubSplineY.ValueInt(tPos) - radius , 2*radius , 2*radius	
	     
		tPos :+speed *Float(curKubSplineX.dataCount)
		Return [curKubSplineX.ValueInt(tPos), curKubSplineY.ValueInt(tPos)]
	End Method
	
	Method updatePoints(newDataT:Int[] , newDataX:Int[] , newDataY:Int[]) 
		curKubSplineX.GetDataInt(newDataT, newDataX) 
		curKubSplineY.GetDataInt(newDataT, newDataY)
	End Method
	
	Method getCurKubSplineX:appKubSpline() 
		Return curKubSplineX
	End Method
	
	Method getCurKubSplineY:appKubSpline() 
		Return curKubSplineY
	End Method	
End Type
...
Type appKubSpline
  ...
  Method getDataY:Float[]()
	Return dataY
  End Method

  Method getDataX:Float[]() 
	Return dataX
  End Method
